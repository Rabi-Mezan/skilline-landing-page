            ...
            <div className="grid grid-cols-2 rounded-b-lg">
                <div className='text-left mt-8'>
                    ...
                    <div className='absolute top-3/4 flex items-center left-32 mt-5'>
                        <button style={{ backgroundColor: '#F48C06' }} class="border-0 py-1 px-3 focus:outline-none rounded-full text-base mt-4 md:mt-0 w-40 h-12 text-center text-white">Join For Free
                        </button>
                        <div className='ml-10 flex items-center'>
                            <img style={{ width: '50px', height: '48px' }} className='' src={playbtn} alt="" />
                            <p className='ml-4'>Watch how it works</p>
                        </div>
